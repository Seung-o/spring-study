...
public class RequestHeaderServlet extends HttpServlet {
    ...
    private void printEtc(HttpServletRequest request) {
        ...
        System.out.println("request.getRemoteHost() = " + request.getRemoteHost()); // 클라이언트 이름
    ...
    private void printHeaderUtils(HttpServletRequest request) {
        ...
        System.out.println("[특별한 헤더 조회]");
        System.out.println("request.getHeader(\"host\") = " + request.getHeader("host")); // Host 헤더
